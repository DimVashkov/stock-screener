...
export class ApiService {
  api = [{
    ...
    "MarketCapitalization": "113947500000",
    "EBITDA": "15659000000",
    "PERatio": "10.53",
    "PEGRatio": "2.154",
    "BookValue": "24.79",
    ...
    "WeekHigh52": "142.43",
    "WeekLow52": "106.73",
    "DayMovingAverage50": "123.05",
    "DayMovingAverage200": "131.31",
  ...
  getStockTickerData(ticker: string): any {
    for (let stock of this.api){
      // let jsonObj: any = JSON.parse(stock);
      if (stock["Symbol"] === ticker){
        const newStock: Stock = <Stock>stock;
        return newStock;
      }
    }
  }
